...
# This class displays the Course management interface.
# Users can add, update, delete, search courses and view all courses in a table.
class CourseClass:
    def __init__(self, root):
        ...
        # Define columns for courses list display
...
#=========================================================
    # ======== Helper functions ========
    def clear(self):
        """Reset input fields to default and refresh the display table."""
        self.show()
        self.var_course.set("")
    ...
    def get_data(self, ev):
        """Fill the input fields with selected row data from the course table."""
