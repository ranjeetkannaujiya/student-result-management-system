...
# This class shows the Student management screen.
# Users can add/update/delete/search student records and view all students.
class studentClass:
    def __init__(self,root):
        ...
        # ========Buttons=======
        self.btn_add=Button(self.root,text="Save",font=("goldy old style",15,"bold"),bg="#2196f3",fg="white",cursor="hand2",command=self.add)
        self.btn_add.place(x=150,y=400,width=110,height=40)

        # ==== Search/UI helper and table initialization done above, now we wire data methods below ====
        self.btn_update=Button(self.root,text="Update",font=("goldy old style",15,"bold"),bg="#4caf50",fg="white",cursor="hand2",command=self.update)
        self.btn_update.place(x=270,y=400,width=110,height=40)

        self.btn_delete=Button(self.root,text="Delete",font=("goldy old style",15,"bold"),bg="#f44336",fg="white",cursor="hand2",command=self.delete)
        self.btn_delete.place(x=390,y=400,width=110,height=40)

        self.btn_clear=Button(self.root,text="Clear",font=("goldy old style",15,"bold"),bg="#607d8b",fg="white",cursor="hand2",command=self.clear)
        ...
        btn_search=Button(self.root,text="Search",font=("goldy old style",15,"bold"),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=1070,y=60,width=120,height=28)
...
#=========================================================
    def clear(self):
        """Reset all entry fields and refresh table display."""
        self.show()
        self.var_roll.set("")
        self.var_name.set("")
        self.var_email.set("")
    ...
    def get_data(self, ev):
        """Load selected student record into form fields."""
    ...
    def fetch_course(self):
        """Fill course list for the course combobox from the database."""
        con=sqlite3.connect(database="rms.db")    
        cur=con.cursor()
        try:
